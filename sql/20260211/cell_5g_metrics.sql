...
-- ----------------------------
CREATE INDEX "idx_cell_5g_metrics_label_time" ON "public"."cell_5g_metrics" USING btree (
...
CREATE INDEX "idx_cell_5g_metrics_time_range" ON "public"."cell_5g_metrics" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" DESC NULLS FIRST
);
...
CREATE INDEX "idx_metrics_5g_userlabel" ON "public"."cell_5g_metrics" USING btree (
  "userlabel" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

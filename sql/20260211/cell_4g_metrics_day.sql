/*
 ...
 Date: 11/02/2026 17:25:37
*/


-- ----------------------------
-- Table structure for cell_4g_metrics_day
-- ----------------------------
DROP TABLE IF EXISTS "public"."cell_4g_metrics_day";
CREATE TABLE "public"."cell_4g_metrics_day" (
...
-- ----------------------------
-- Indexes structure for table cell_4g_metrics_day
-- ----------------------------
CREATE INDEX "idx_cell_4g_day_omcr_time" ON "public"."cell_4g_metrics_day" USING btree (
  "omcr" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "start_time" "pg_catalog"."timestamp_ops" DESC NULLS FIRST
);
CREATE INDEX "idx_cell_4g_day_time_range" ON "public"."cell_4g_metrics_day" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" DESC NULLS FIRST
);
CREATE UNIQUE INDEX "idx_pg_4g_day_unique" ON "public"."cell_4g_metrics_day" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST,
  "cell_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "idx_pg_4g_hour_unique_copy1" ON "public"."cell_4g_metrics_day" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST,
  "cell_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "idx_pg_4g_unique_copy1_copy1" ON "public"."cell_4g_metrics_day" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST,
  "cgi" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table cell_4g_metrics_day
-- ----------------------------
ALTER TABLE "public"."cell_4g_metrics_day" ADD CONSTRAINT "cell_4g_metrics_hour_copy1_start_time_cell_id_key" UNIQUE ("start_time", "cell_id");

-- ----------------------------
-- Primary Key structure for table cell_4g_metrics_day
-- ----------------------------
ALTER TABLE "public"."cell_4g_metrics_day" ADD CONSTRAINT "cell_4g_metrics_hour_copy1_pkey" PRIMARY KEY ("id");
